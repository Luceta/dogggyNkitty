...
function Modal({ open, close, logout, productModal, userModal, handleDelete, handleEdit, storeLink }) {
  return (
      ...
      <div className={open ? "openModal modal" : "modal"}>
        ...
        {productModal && (
          <Options>
            ...
            <li>
              {storeLink ? (
                <a href={storeLink}>웹 사이트에서 상품 보기 </a>
              ) : (
                <StyledLink to="/">웹 사이트에서 상품 보기</StyledLink>
              )}
            </li>
          </Options>
        )}
